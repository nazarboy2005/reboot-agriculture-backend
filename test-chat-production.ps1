# Test script for chat functionality on production backend
Write-Host "Testing chat functionality on production backend..."

$baseUrl = "https://agriculture-backend-1077945709935.europe-west1.run.app"
